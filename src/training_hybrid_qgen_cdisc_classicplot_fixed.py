...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--n-critic-g", type=int, default=1,
    ...
    parser.add_argument("--use-mbd", action="store_true", default=True,
                        help="Aktiviert Minibatch Discrimination (default an).")
    parser.add_argument("--no-mbd", dest="use_mbd", action="store_false")
